...
- **Contracts** 列出工作区的 Truffle 项目中包含的合约. For more information on how Ganache handles contracts, see our [Contracts Page documentation](/docs/ganache/truffle-projects/contracts-page).
...
本指南让您开始使用零配置的个人以太坊开发区块链. 如果您有一个现有的 Truffle 项目，希望在此工作空间中跟踪其合约和事件，请查看[链接 Truffle 项目文档](/docs/ganache/truffle-projects/linking-a-truffle-project).
