...
将存储库添加到 Truffle 团队, 导航[https://my.truffleteams.com](https://my.truffleteams.com).
...
注意: Truffle 团队只会构建存储库根 root 的存储库。
